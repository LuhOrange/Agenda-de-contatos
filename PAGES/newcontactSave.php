<?php
    ...
    if(isset($_POST['submit'])) // Verifica se o formulário foi enviado pelo botão 'submit'
    {
        ...
        // Executa uma consulta para inserir os dados na tabela 'contatos' do banco de dados

        $result = mysqli_query($conexao, "INSERT INTO contatos(nome, telefone, endereco, email) 
...
<body>
    ...
    <div class="bloco">    
        <div class="container">
            <h1>Contato salvo com sucesso!</h1><br>
            <div class="botao">
